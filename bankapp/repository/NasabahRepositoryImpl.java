...
public class NasabahRepositoryImpl implements NasabahRepository {
    ...
    // Perbaikan: Hapus constructor lama karena kita tidak lagi menerima EntityManager.
    
    private static final String JDBC_URL = "jdbc:mysql://localhost:3306/bank_app_db?serverTimezone=UTC";
    private static final String JDBC_USER = "root"; 
    private static final String JDBC_PASS = "";     

    // FIX: Method findMaxNomorRekening() yang hilang (untuk counter di BankService)
    public long findMaxNomorRekening() {
        EntityManager em = JpaUtil.getEntityManager(); 
        try {
            // JPQL untuk mencari nomor rekening terbesar (MAX(String) bekerja jika format konsisten)
