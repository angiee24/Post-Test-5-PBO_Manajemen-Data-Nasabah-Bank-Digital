...
public abstract class Nasabah implements Transaksi {
    ...
    // MAPPING FIX: Menyelaraskan nama Java (nomorRekening) dengan DB (nomor_rekening)
    ...
    // FIX: Relasi One-to-Many dengan CASCADE ALL untuk menghapus mutasi saat Nasabah dihapus
    ...
    // METHOD catat() FINAL FIX: Diubah menjadi public untuk diakses BankService
    ...
    // ====== Implementasi Transaksi (Diubah untuk memanggil catat() baru) ======
    @Override
